...
open class ActiveLabel: UILabel {
    ...
    fileprivate func addLinkAttribute(_ mutAttrString: NSMutableAttributedString) {
        ...
        for (type, elements) in activeElements {
            ...
            switch type {
            case .mention: attributes += mentionTextAttributes
            case .hashtag: attributes += hashtagTextAttributes
            case .url: attributes += URLTextAttributes
            case .custom: attributes += customTextAttributes[type]
            }
    ...
    fileprivate func updateAttributesWhenSelected(_ isSelected: Bool) {
        ...
        if isSelected {
            switch type {
            case .mention: attributes += mentionSelectedTextAttributes
            case .hashtag: attributes += hashtagSelectedTextAttributes
            case .url: attributes += URLSelectedLTextAttributes
            case .custom: attributes += customSelectedTextAttributes[selectedElement.type]
            }
        } else {
            switch type {
            case .mention: attributes += mentionTextAttributes
            case .hashtag: attributes += hashtagTextAttributes
            case .url: attributes += URLTextAttributes
            case .custom: attributes += customTextAttributes[selectedElement.type]
            }
        }
